...
> 如转载分享，请保留出处，谢谢 😆
> 
> 原文地址: [https://shockerli.net/post/php-awesome](https://shockerli.net/post/php-awesome)
> 
> GitHub: [https://github.com/shockerli/php-awesome](https://github.com/shockerli/php-awesome)

+   **PHP PSR 代码标准**
    
    +   官网: [https://www.php-fig.org](https://www.php-fig.org/)
    +   原文: [https://github.com/php-fig/fig-standards](https://github.com/php-fig/fig-standards)
    +   中文: [https://psr.phphub.org](https://psr.phphub.org/)
...
+   [Text\_Diff](https://github.com/pear/Text_Diff) - 代码文件比较工具
...
+   [random\_compat](https://github.com/paragonie/random_compat) - PHP 5.x 版本的 `random_bytes()` 和 `random_int()`
...
+   [PHP\_CodeSniffer](https://github.com/squizlabs/php_codesniffer) - PHP/JavaScript/CSS 代码规范检查工具
...
+   [password\_compat](https://github.com/ircmaxell/password_compat) - PHP版本 5.3.7 以上的 `password_*` 函数实现
...
+   中文站: [http://www.phpcomposer.com](http://www.phpcomposer.com/)
+   包仓库: [https://packagist.org](https://packagist.org/)
+   [Composer Installers](https://github.com/composer/installers): 多框架 Composer 库安装器
+   中国全量镜像: [https://pkg.phpcomposer.com](https://pkg.phpcomposer.com/)
